...
The metadata for the Rotoehu project is within the `rotoehu_data.zip` folder. This folder contains the metadata for the project, including the device position, device variable, quality control filters, sensor calibrations, sensor reference, sensor scaling, site devices, site events, sites and variables.

In this document, we will describe the contents of each file in the `rotoehu_data.zip` folder. The files are in CSV format.
...
-   `temperature`: The temperature of the reference measurement. - `comment`: The comment for the reference measurement.
