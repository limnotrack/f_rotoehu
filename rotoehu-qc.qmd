...
# p1 <- plot_var_qc(data = data, var_ref_id = c("t_wtr_d100", "t_wtr_d1000"))

p2 <- plot_qc_code_ts(data = data, var_ref_id = c("t_wtr_d100", "t_wtr_d1000"))

# p3 <- plot_device_ts(data = data, var_ref_id = c("t_wtr_d100", "t_wtr_d1000"))
...
<a href="https://github.com/limnotrack/f_rotoehu/releases/download/v0.0.1/rotoehu_data.zip" download class="btn btn-primary">Download Data</a>
